...
* From <https://people.eecs.berkeley.edu/~necula/Papers/NelsonOppenCong.pdf>,
  ...
  * We conclude Section 4 with a curiosity: If the axiomatization of the theory of list
    structure is altered by specifying the result of CAR and CDR on atoms, the problem of
    determining the satisfiability of a conjunction becomes NP-complete.
